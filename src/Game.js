...
class Game { // main game class
  ...
  start() { // on begin play
    ...
    this.playerTileCheck = new PlayerTileCheck(this.player, this.canvas, this.context, this.camera);
    ...
    this.tileCheckerTop = new TileChecker(0, -64, this.map, this.context, this.camera, this.player, "up", this.playerTileCheck)
    this.tileCheckerBottom = new TileChecker(0, 64,this.map, this.context, this.camera, this.player, "down", this.playerTileCheck)

    this.tileCheckerRight = new TileChecker(64, 0, this.map, this.context, this.camera, this.player, "right", this.playerTileCheck);
    this.tileCheckerLeft = new TileChecker(-64, 0, this.map, this.context, this.camera, this.player, "left", this.playerTileCheck);
    this.eventManager = new EventManager(this.canvas, this.context, this.camera, this.player, this.playerTileCheck);
  ...
  update() {
    ...
    console.log(" Up:",this.playerTileCheck.rememberUp,
      " Down:", this.playerTileCheck.rememberDown,
      " Left:", this.playerTileCheck.rememberLeft,
      " Right:",this.playerTileCheck.rememberRight);
  ...
  render(lagOffset) {
    ...
    this.map.checkTilesLayer(this.playerTileCheck, this.playerTileCheck.x, this.playerTileCheck.y);
